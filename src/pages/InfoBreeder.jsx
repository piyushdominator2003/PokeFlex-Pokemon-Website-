...
const InfoBreeder = () => {
  ...
  const breeder1 = breeder.filter((item) => item.id === parseInt(id))

  const trainerdetail = breeder1[0]
           ...
           return(
            <div className="image" key={i} data-aos='fade-left'>
              ...
              <div className="pokemon-details">
                ...
                <Link to={`/info/${id}/${v.p1name}/${v.pid}`} className='pokemon-link'><button>View Pokemon</button></Link>
              </div>
            </div>
           )
        })}
